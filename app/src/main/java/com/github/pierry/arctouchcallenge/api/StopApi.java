...
@EBean public class StopApi implements IStopApi {
  ...
  @Override public void stopByRouteId(final long id) {
    ...
    api.post(Api.FIND_STOP_BY_ID, json).setCallback(new FutureCallback<Response<JsonObject>>() {
